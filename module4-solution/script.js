...
(function () {
  ...
  names.map(namesMapper).forEach(mappedName => {
  ...
  reducedNames.hello.forEach(reducedHelloName => {
    console.log(reducedHelloName);
  })
  console.log("\r\n");

  reducedNames.bye.forEach(reducedByeName => {
    console.log(reducedByeName);
  })
})();